import { ADD_TODO, EDIT_TODO, DELETE_TODO, EDIT_STATUS } from "../actionTypes";
  ...
  switch (action.type) {
    ...
    case EDIT_TODO: {
      ...
      if (todoIndex !== -1) {
        ...
        updatedTodoList[todoIndex] = { ...updatedTodoList[todoIndex], id, task };
        return {
          ...state,
    ...
    case EDIT_STATUS: {
      ...
      if (todoIndex !== -1) {
        const updatedTodoList = [...state.todo_list];
        updatedTodoList[todoIndex] = { ...updatedTodoList[todoIndex], id, status };
        return {
          ...state,
          todo_list: updatedTodoList
        };
